...
function epithelial(kind){
 ...
 if(kind==="iecstem") return `<path d="M36 10Q32 10 32 16l5 69q1 8 8 9h10q7-1 8-9l5-69q0-6-4-6z" fill="#ADD9BA" stroke="#5F9E77" stroke-width="2.2" stroke-linejoin="round"/><path d="M33 17q17 4 34 0" fill="none" stroke="#497F62" stroke-width="2"/><g stroke="#497F62" stroke-width="1.35" stroke-linecap="round"><path d="M38 11V4"/><path d="M44 10V3"/><path d="M50 10V2"/><path d="M56 10V3"/><path d="M62 11V4"/></g><path d="M39 27q11-5 22 0M40 31q10-4 20 0" fill="none" stroke="#79AD89" stroke-width="1.2"/><g fill="#D38169" stroke="#925448" stroke-width=".8"><ellipse cx="42" cy="40" rx="4.5" ry="2.4" transform="rotate(-20 42 40)"/><ellipse cx="58" cy="45" rx="4.5" ry="2.4" transform="rotate(18 58 45)"/><ellipse cx="43" cy="52" rx="3.8" ry="2.1" transform="rotate(12 43 52)"/></g><g fill="none" stroke="#F0B27E" stroke-width=".7"><path d="M39 40q3-2 6 0"/><path d="M55 45q3-2 6 0"/><path d="M40 52q3-2 6 0"/></g>${smallNucleus(50,70,12,16,"#537565")}<path d="M43 91h14" stroke="#497F62" stroke-width="2" stroke-linecap="round"/>`;
...
function lab(kind){
 ...
 if(kind==="testtube") return `<path d="M35 14h30v57q0 18-15 18T35 71z" fill="${glass}" fill-opacity=".74" stroke="#5E8795" stroke-width="2.1"/><path d="M33 14h34v7H33z" fill="#EAF5F6" stroke="#5E8795" stroke-width="1.7"/><path d="M39 55h22v16q0 14-11 14T39 71z" fill="${pink}" fill-opacity=".82"/><path d="M39 55q11-4 22 0" fill="none" stroke="#A95655" stroke-width="1.2"/><path d="M17 29h18M65 29h18M22 29v57M78 29v57M17 86h66" fill="none" stroke="${dark}" stroke-width="2.6" stroke-linecap="round"/><path d="M28 38h7M28 48h7M65 38h7M65 48h7" stroke="#6D939F" stroke-width="1"/><circle cx="46" cy="68" r="1.5" fill="#F1B7AA"/>`;
 if(kind==="petri") return `<ellipse cx="50" cy="56" rx="43" ry="28" fill="#C8DDE2" fill-opacity=".55" stroke="#618895" stroke-width="2"/><ellipse cx="50" cy="49" rx="43" ry="28" fill="#F0E5BD" fill-opacity=".72" stroke="#7AA0AB" stroke-width="1.7"/><ellipse cx="50" cy="49" rx="37" ry="22" fill="#F4E9C8" stroke="#D0B66B" stroke-width=".9"/><path d="M21 56q9-25 35-24 20 0 28 15M25 61q13-18 37-17M33 65q12-11 34-9" fill="none" stroke="#C8A34F" stroke-width="1" stroke-dasharray="2.2 2"/>${[[27,43,3.2,"#D7A64F"],[39,54,2.2,"#C8874D"],[55,37,3.8,"#E0B963"],[68,51,2.7,"#B9854E"],[59,61,1.8,"#D79A56"],[75,42,1.5,"#B77445"]].map(([x,y,r,c])=>`<circle cx="${x}" cy="${y}" r="${r}" fill="${c}" stroke="#9B6B3E" stroke-width=".6"/><circle cx="${x-1}" cy="${y-1}" r="${Math.max(.5,r*.28)}" fill="#F2D894"/>`).join("")}`;
 if(kind==="dish") return `<ellipse cx="50" cy="56" rx="43" ry="28" fill="#C9DEE4" fill-opacity=".58" stroke="#618895" stroke-width="2"/><ellipse cx="50" cy="49" rx="43" ry="28" fill="#F3B8B5" fill-opacity=".64" stroke="#7AA0AB" stroke-width="1.7"/><ellipse cx="50" cy="49" rx="37" ry="22" fill="#F7C8C5" fill-opacity=".74" stroke="#D68D8B" stroke-width=".8"/>${[[26,45],[36,57],[47,41],[58,55],[70,44],[53,65],[76,57]].map(([x,y],i)=>`<path d="M${x-5} ${y}q3-5 6-2 4-3 6 2-3 5-7 3-4 3-5-3z" fill="${i%2?"#D77C82":"#E29191"}" stroke="#A85B64" stroke-width=".7"/><ellipse cx="${x+1}" cy="${y}" rx="1.7" ry="2.1" fill="#78566F"/>`).join("")}<path d="M15 39q35-16 70 0" fill="none" stroke="#EAF5F6" stroke-width="1"/>`;
 if(kind==="microplate") return `<path d="M8 28l10-9h74v60l-10 8H8z" fill="#DCEAED" stroke="#5D8493" stroke-width="2"/><path d="M12 30h72v51H12z" fill="#EEF5F6" stroke="#8DA9B2" stroke-width=".8"/>${Array.from({length:96},(_,i)=>{const c=i%12,r=Math.floor(i/12),x=16+c*5.9,y=34+r*5.8,fill=(i%17===0||i%19===0)?pink:(i%13===0?yellow:"#C6DDE3");return `<ellipse cx="${x.toFixed(1)}" cy="${y.toFixed(1)}" rx="2.25" ry="1.85" fill="${fill}" stroke="#6E98A7" stroke-width=".5"/><ellipse cx="${x.toFixed(1)}" cy="${(y-.45).toFixed(1)}" rx="1.15" ry=".65" fill="#EEF7F8" fill-opacity=".7"/>`;}).join("")}<path d="M18 19h74v60l-10 8" fill="none" stroke="#91AAB2" stroke-width="1"/><path d="M8 28l5 4M92 19l-5 5" stroke="#5D8493" stroke-width="1.4"/>`;
 if(kind==="pipette") return `<g transform="rotate(-31 50 50)" stroke-linejoin="round"><rect x="39" y="7" width="22" height="49" rx="8" fill="${blue}" stroke="#4D7488" stroke-width="2"/><path d="M44 6V2h12v4" fill="${pink}" stroke="#A85755" stroke-width="1.4"/><rect x="43" y="17" width="14" height="9" rx="2" fill="#E9F1F2" stroke="#4D7488"/><text x="50" y="23" text-anchor="middle" font-family="sans-serif" font-size="5" fill="#3F5761">020</text><path d="M41 31h18M41 38h18" stroke="#CFE2E7" stroke-width="1.3"/><path d="M61 20h8q4 0 4 4t-4 4h-8" fill="#AAC1C8" stroke="#4D7488" stroke-width="1.5"/><path d="M43 55h14l-3 17h-8z" fill="#C3D5DA" stroke="#587E8D" stroke-width="1.5"/><path d="M46 72h8l-2 22h-4z" fill="#EAF5F6" stroke="#678C99" stroke-width="1.2"/><path d="M48 94h4l-2 4z" fill="#D6EEF1" stroke="#678C99" stroke-width=".8"/><path d="M38 28h-5v18h7" fill="none" stroke="#4D7488" stroke-width="1.7"/></g>`;
 if(kind==="pcrtube") return `<path d="M5 25h90v7H5z" fill="#A9C0C7" stroke="${dark}" stroke-width="1.5"/>${Array.from({length:8},(_,i)=>{const x=7+i*11;return `<path d="M${x} 31h10l-1.5 39q-1 8-3.5 10-2.5-2-3.5-10z" fill="#E6F2F4" fill-opacity=".78" stroke="#618B99" stroke-width="1.15"/><path d="M${x+2} 62h6l-1 9q-1 4-2 5-2-3-2-5z" fill="${i%3===0?pink:"#8FC5D2"}" fill-opacity=".75"/><path d="M${x-1} 24q5-8 12 0v7H${x-1}z" fill="#D9EAED" stroke="#618B99" stroke-width="1"/><path d="M${x+1} 24q4-3 8 0" fill="none" stroke="#89A9B3" stroke-width=".8"/>`;}).join("")}<path d="M5 25h90M10 32v4M21 32v4M32 32v4M43 32v4M54 32v4M65 32v4M76 32v4M87 32v4" stroke="#526A74" stroke-width=".8"/>`;
 if(kind==="centrifuge") return `<path d="M17 43q0-8 8-8h50q8 0 8 8v38q0 6-6 6H23q-6 0-6-6z" fill="${body}" stroke="${dark}" stroke-width="2"/><path d="M24 36Q21 20 32 13h36q11 7 8 23" fill="#DCE8EA" fill-opacity=".65" stroke="${dark}" stroke-width="2"/><ellipse cx="50" cy="34" rx="24" ry="17" fill="#AEBFC4" stroke="#586A72" stroke-width="1.6"/><circle cx="50" cy="34" r="13" fill="#657880" stroke="#3E4D54" stroke-width="1.3"/>${Array.from({length:8},(_,i)=>{const a=i*Math.PI/4,x=50+9*Math.cos(a),y=34+9*Math.sin(a);return `<ellipse cx="${x.toFixed(1)}" cy="${y.toFixed(1)}" rx="2.4" ry="4" fill="${i%4===0?pink:"#263D47"}" transform="rotate(${i*45} ${x.toFixed(1)} ${y.toFixed(1)})"/>`;}).join("")}<path d="M26 60h29v13H26z" fill="#263D47" stroke="#536A74"/><text x="40.5" y="69" text-anchor="middle" font-family="sans-serif" font-size="6" fill="#72D1CC">12000</text><circle cx="67" cy="66" r="4" fill="${green}"/><circle cx="76" cy="66" r="3" fill="${yellow}"/><path d="M21 48h58" stroke="#91A2A8" stroke-width="1"/><path d="M25 87v3M75 87v3" stroke="${dark}" stroke-width="2"/>`;
 if(kind==="syringe") return `<g transform="rotate(-25 50 50)" stroke-linejoin="round"><path d="M25 35h49v24H25z" fill="${glass}" fill-opacity=".76" stroke="#5A8392" stroke-width="1.8"/><path d="M42 38h29v18H42z" fill="#8FC6D0" fill-opacity=".62"/><path d="M33 37v20M40 37v7M47 37v7M54 37v7M61 37v7M68 37v7" stroke="#6E939F" stroke-width=".9"/><path d="M19 40h6v14h-6z" fill="#50626B" stroke="#37474E"/><path d="M7 35v24M7 47h12M12 39v16" fill="none" stroke="${dark}" stroke-width="2.2"/><path d="M74 41h7v12h-7z" fill="#B9CCD1" stroke="#5A8392" stroke-width="1.2"/><path d="M81 47h17" stroke="${dark}" stroke-width="1.5"/><path d="M98 47l5-1" stroke="#88969C" stroke-width=".8"/><path d="M25 32v30M74 32v30" stroke="#5A8392" stroke-width="1"/><path d="M21 34h8M21 60h8M70 34h8M70 60h8" stroke="#5A8392" stroke-width="1.5"/></g>`;
 if(kind==="vial") return `<path d="M30 29h40v50q0 9-9 9H39q-9 0-9-9z" fill="${glass}" fill-opacity=".76" stroke="#5B8492" stroke-width="2"/><path d="M32 61h36v18q0 6-7 6H39q-7 0-7-6z" fill="${yellow}" fill-opacity=".72"/><path d="M32 61q18-5 36 0" fill="none" stroke="#B4853F" stroke-width="1.2"/><path d="M27 16h46v16H27z" fill="${blue}" stroke="#4D7488" stroke-width="1.8"/><ellipse cx="50" cy="17" rx="19" ry="5" fill="#49565C" stroke="#354047" stroke-width="1.2"/><ellipse cx="50" cy="18" rx="12" ry="3" fill="#9AA6A8"/><path d="M31 20v10M36 19v12M64 19v12M69 20v10" stroke="#D3E1E4" stroke-width=".8"/><rect x="37" y="39" width="26" height="17" rx="2" fill="#FBF7EA" stroke="#A9A49A"/><path d="M41 44h18M41 48h12M41 52h16" stroke="#809095" stroke-width="1"/>`;
 if(kind==="incubator") return `<rect x="19" y="7" width="62" height="87" rx="4" fill="${body}" stroke="${dark}" stroke-width="2.2"/><rect x="25" y="13" width="50" height="14" rx="2" fill="#263D47" stroke="#50656F"/><text x="37" y="22" text-anchor="middle" font-family="sans-serif" font-size="6" fill="#72D1CC">37.0°C</text><text x="62" y="22" text-anchor="middle" font-family="sans-serif" font-size="6" fill="#72D1CC">5.0%</text><circle cx="71" cy="10" r="2" fill="${green}"/><rect x="25" y="31" width="48" height="54" rx="2" fill="#78909A" stroke="#516973" stroke-width="1.6"/><rect x="29" y="35" width="40" height="46" fill="#E7F1F2" fill-opacity=".42" stroke="#C8D9DD"/>${[47,61,75].map(y=>`<path d="M30 ${y}h38" stroke="#D9E6E8" stroke-width="1.5"/>`).join("")}<path d="M35 44h12l4-6h6l4 6h4v3H35z" fill="#B9D8D9" stroke="#66888D" stroke-width=".8"/><ellipse cx="45" cy="58" rx="10" ry="3" fill="#F2B2B1" stroke="#A76567" stroke-width=".8"/><path d="M34 72h10v5H34zM52 70h12v7H52z" fill="#B5D1D5" stroke="#66888D" stroke-width=".8"/><path d="M75 38h4v27h-4" fill="#687A82"/><rect x="30" y="82" width="38" height="3" fill="#8BA5AB"/><path d="M24 94v3M76 94v3" stroke="${dark}" stroke-width="2"/>`;
 if(kind==="freezer") return `<rect x="20" y="6" width="60" height="88" rx="4" fill="${body}" stroke="${dark}" stroke-width="2.3"/><rect x="26" y="12" width="48" height="16" rx="2" fill="#263D47" stroke="#50656F"/><text x="43" y="23" text-anchor="middle" font-family="sans-serif" font-size="9" fill="#72D1CC">−80</text><circle cx="66" cy="19" r="2.6" fill="${green}"/><rect x="27" y="32" width="43" height="53" rx="2" fill="#EEF3F3" stroke="#7E929A" stroke-width="1.3"/>${[32,45,58,71].map((y,i)=>`<rect x="31" y="${y+3}" width="35" height="10" rx="1.5" fill="${i%2?"#D5E0E2":"#E3E9EA"}" stroke="#9AADB2" stroke-width=".8"/><path d="M45 ${y+8}h8" stroke="#778B92" stroke-width="1"/>`).join("")}<path d="M73 34h5v38h-5" fill="#65777F" stroke="#46555B" stroke-width="1"/><path d="M24 30h52M24 88h52" stroke="#A6B5BA" stroke-width="1"/><path d="M25 94v3M75 94v3" stroke="${dark}" stroke-width="2"/>`;
...
const labUpgradeBackupDir=path.join(root,"backups","2026-08-04-before-lab-detail-upgrade");
const labUpgradeMarker=path.join(labUpgradeBackupDir,"BACKUP_COMPLETE");
if(!fs.existsSync(labUpgradeMarker)){
 fs.mkdirSync(path.join(labUpgradeBackupDir,"biology"),{recursive:true});
 for(const id of labIds){
  const current=path.join(outDir,`${id}.svg`);
  if(fs.existsSync(current))fs.copyFileSync(current,path.join(labUpgradeBackupDir,"biology",`${id}.svg`));
 }
 for(const name of ["biology-assets.js"]){const current=path.join(root,"app",name);if(fs.existsSync(current))fs.copyFileSync(current,path.join(labUpgradeBackupDir,name));}
 fs.writeFileSync(labUpgradeMarker,"Current Biology > Lab assets saved before the detailed Lab upgrade.\n");
}
