...
/* ============================ FACTORY ============================ */
function addIcon(kind,cx,cy){const sz=ICON_SIZES[kind]||[128,128];const o={id:gid(),type:"icon",shapeKind:kind,x:cx,y:cy,w:sz[0],h:sz[1],rot:0,opacity:1,shadow:false,shadowBlur:5,brightness:100,saturate:100,hue:0,tint:null,tintAmt:0};if(RECOLOR.has(kind))o.fill="#3A3F45";commitAdd(o);return o;}
function addShape(kind,cx,cy,opt){opt=opt||{};const o=Object.assign({id:gid(),type:"shape",shapeKind:kind,x:cx,y:cy,w:150,h:100,rot:0,opacity:1,fill:"#EFE6DD",stroke:"#BF6141",strokeWidth:2,dash:false,shadow:false,shadowBlur:4},opt);commitAdd(o);return o;}
