...
var ICONS = {
  ...
  organ_heart:`<path d="M40 28c-12 0-20 8-20 19 0 16 19 27 30 36 11-9 30-20 30-36 0-11-8-19-20-19-6 0-9 3-10 6-1-3-4-6-10-6z" fill="#CE5248" stroke="#9E2C24" stroke-width="2.5" stroke-linejoin="round"/><path d="M44 27c1-7 7-10 7-10M58 28c-1-6-5-10-5-10" fill="none" stroke="#B85045" stroke-width="5" stroke-linecap="round"/>`,
  organ_lung:`<path d="M48 16v18M37 30h26" stroke="#9A8A8A" stroke-width="4" stroke-linecap="round"/><path d="M45 34c-1 18-9 28-18 32-6 3-11-2-11-11 0-17 9-29 19-31 6-1 10 4 10 10z" fill="#D88E9A" stroke="#A85E6A" stroke-width="2.2" stroke-linejoin="round"/><path d="M55 34c1 18 9 28 18 32 6 3 11-2 11-11 0-17-9-29-19-31-6-1-10 4-10 10z" fill="#D88E9A" stroke="#A85E6A" stroke-width="2.2" stroke-linejoin="round"/>`,
  organ_stomach:`<path d="M42 16c-3 12-1 18 5 22 16 7 24 16 19 31-5 14-22 17-31 8" fill="none" stroke="#B0584A" stroke-width="2.6" stroke-linecap="round"/><path d="M42 16c-3 12-1 18 5 22 16 7 24 16 19 31-4 12-17 16-26 11-5-3-6-9-2-11 3-2 5 1 8 3 5 3 10 1 12-4 2-7-4-11-14-15-12-5-15-13-12-26 1-4 3-8 5-10z" fill="#E89A8A" stroke="#B0584A" stroke-width="2.4" stroke-linejoin="round"/>`,
  organ_liver:`<path d="M16 38c20-9 50-11 68-5 7 2 5 15-4 21-16 11-44 15-58 5-6-4-8-17-6-21z" fill="#A65A4A" stroke="#7A3A2E" stroke-width="2.5" stroke-linejoin="round"/><path d="M52 34v28" stroke="#7A3A2E" stroke-width="2"/><path d="M30 58q6 4 12 2" fill="none" stroke="#7A3A2E" stroke-width="2"/>`,
  organ_pancreas:`<path d="M16 42c16-8 42-10 62-3 8 3 7 12-1 13-17 3-31-1-42 4-9 4-26 0-19-14z" fill="#E0B06A" stroke="#B08A3A" stroke-width="2.3" stroke-linejoin="round"/><circle cx="78" cy="50" r="6" fill="#E0B06A" stroke="#B08A3A" stroke-width="2.3"/>`,
  organ_kidney:`<path d="M58 22c14 0 24 12 24 28s-10 28-24 28c-9 0-14-6-14-12 0-5 4-8 4-16s-4-11-4-16c0-6 5-12 14-12z" fill="#9A5A6E" stroke="#6E3A4E" stroke-width="2.5" stroke-linejoin="round"/><path d="M44 50h10" stroke="#6E3A4E" stroke-width="4" stroke-linecap="round"/><path d="M54 50l8-7M54 50l8 7" stroke="#6E3A4E" stroke-width="3" stroke-linecap="round"/>`,
  organ_spleen:`<ellipse cx="50" cy="50" rx="22" ry="31" transform="rotate(22 50 50)" fill="#8A4A6E" stroke="#5E2E4E" stroke-width="2.5"/><path d="M40 34q8 16 22 30" fill="none" stroke="#5E2E4E" stroke-width="1.8" opacity=".5"/>`,
  ...
  organ_uterus:`<path d="M34 30c0 15 6 23 16 23s16-8 16-23" fill="#D88EA0" stroke="#A85E72" stroke-width="2.5" stroke-linejoin="round"/><path d="M34 30c-5-3-10 1-13 7M66 30c5-3 10 1 13 7" fill="none" stroke="#A85E72" stroke-width="4" stroke-linecap="round"/><circle cx="18" cy="40" r="5.5" fill="#E8B0BE" stroke="#A85E72" stroke-width="2"/><circle cx="82" cy="40" r="5.5" fill="#E8B0BE" stroke="#A85E72" stroke-width="2"/><path d="M50 53v22" stroke="#A85E72" stroke-width="7" stroke-linecap="round"/>`,
  organ_bladder:`<path d="M30 44c0-12 8-19 20-19s20 7 20 19c0 14-8 24-20 24s-20-10-20-24z" fill="#E6CE76" stroke="#B0982E" stroke-width="2.5" stroke-linejoin="round"/><path d="M44 26l-3-9M56 26l3-9" stroke="#B0982E" stroke-width="3.4" stroke-linecap="round"/>`
};
...
var NETWORK_PRESETS = [
  ["net:saved1","Preset-Network 1"],["net:saved2","Preset-Network 2"],
